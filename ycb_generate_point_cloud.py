...
data = scipy.io.loadmat ('C:\\Users\\hp\\Documents\\MATLAB\\ObjectRecognition_YCB\\ObjectProperties.mat')

# Parameters
ycb_data_folder = data ['InfoFolder'] [0]	# Folder that contains the ycb data.	
target_object = data ['InfoObject'] [0]		# Full name of the target object.
viewpoint_camera = data['InfoCamera'] [0]	# Camera which the viewpoint will be generated.
viewpoint_angle = data ['InfoAngle'] [0]		# Relative angle of the object w.r.t the camera (angle of the turntable).
